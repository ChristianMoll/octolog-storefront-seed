...
const ShippingStep = ({
  ...
  if (isCompleted) {
    ...
    const { label, description, price, currency } = shippingMethod ?? {};
      ...
      <div className="px-4 pb-4 lg:px-0 lg:pb-6">
        <div className="md:rounded-md md:border md:border-neutral-400 md:p-5">
          <div className={classnames('flex items-center justify-between')}>
            <div>
              <h6 className="text-14 font-medium leading-loose text-gray-700">{label}</h6>
    ...
    <div>
      <div className="px-px">
        <div className="grid grid-cols-1 gap-px">
          {shippingMethods.map(({ id, label, price, currency, description }, index, arr) => (
            <div
              key={id}
